...
import com.scwang.smart.refresh.drawable.ProgressDrawable;
...
//            mLastUpdateText.setTextSize(12);
        ...
        updateView.setVisibility(mEnableLastTime ? View.VISIBLE : View.GONE);
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        switch (newState) {
            ...
            case Loading:
                arrowView.setVisibility(View.GONE);
                updateView.setVisibility(mEnableLastTime ? View.INVISIBLE : View.GONE);
    ...
    public ClassicsHeader setEnableLastTime(boolean enable) {
        ...
        updateView.setVisibility(enable ? View.VISIBLE : View.GONE);
