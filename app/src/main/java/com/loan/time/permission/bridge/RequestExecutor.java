...
import com.loan.time.bridge.IBridge;
 ...
 */
final class RequestExecutor extends Thread implements com.loan.time.permission.bridge.Messenger.Callback {
    ...
    public void run() {
        ...
        mMessenger = new com.loan.time.permission.bridge.Messenger(context, this);
