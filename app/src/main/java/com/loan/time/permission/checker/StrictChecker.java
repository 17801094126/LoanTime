 ...
 */
package com.loan.time.permission.checker;

import android.content.ContentResolver;
import android.content.Context;
import android.os.Build;

import com.loan.time.permission.checker.PermissionChecker;
...
public final class StrictChecker implements PermissionChecker {
    ...
    private static boolean checkWriteCalendar(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.CalendarWriteTest(context);
        return test.test();
    }

    private static boolean checkCamera(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.CameraTest(context);
        return test.test();
    }

    private static boolean checkReadContacts(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.ContactsReadTest(context);
        return test.test();
    }

    private static boolean checkWriteContacts(Context context) throws Throwable {
        ContentResolver resolver = context.getContentResolver();
        PermissionTest test = new com.loan.time.permission.checker.ContactsWriteTest(resolver);
        return test.test();
    }

    private static boolean checkCoarseLocation(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.LocationCoarseTest(context);
        return test.test();
    }

    private static boolean checkFineLocation(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.LocationFineTest(context);
        return test.test();
    }
    ...
    private static boolean checkReadPhoneState(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.PhoneStateReadTest(context);
        return test.test();
    }
    ...
    private static boolean checkWriteCallLog(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.CallLogWriteTest(context);
        return test.test();
    }

    private static boolean checkSip(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.SipTest(context);
        return test.test();
    }

    private static boolean checkSensorHeart(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.SensorHeartTest(context);
        return test.test();
    }
    ...
    private static boolean checkReadSms(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.SmsReadTest(context);
        return test.test();
    }

    private static boolean checkReadStorage() throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.StorageReadTest();
        return test.test();
    }

    private static boolean checkWriteStorage(Context context) throws Throwable {
        PermissionTest test = new com.loan.time.permission.checker.StorageWriteTest(context);
        return test.test();
    }
}