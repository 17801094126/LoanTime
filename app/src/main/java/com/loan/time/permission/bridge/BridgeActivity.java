 ...
 */
package com.loan.time.permission.bridge;
...
import com.loan.time.permission.bridge.BridgeRequest;
import com.loan.time.permission.overlay.setting.LSettingPage;
import com.loan.time.permission.overlay.setting.MSettingPage;
import com.loan.time.permission.source.ActivitySource;
...
public final class BridgeActivity extends Activity {
    ...
    static void requestAppDetails(Source source, String suffix) {
        Intent intent = new Intent(source.getContext(), com.loan.time.permission.bridge.BridgeActivity.class);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        com.loan.time.permission.bridge.Messenger.send(this, mActionSuffix);
        finish();
    }
